...
const Footer = ({ activeTab, setActiveTab, t }) => {
    ...
    return (
        <View style={styles.container}>
            <LinearGradient
                ...
                style={[styles.bottomNav, { paddingBottom: bottomPadding }]}
            >
                        ...
                        >
                            <View style={styles.iconContainer}>
                                <Icon
                                    ...
                                    color={isActive ? COLORS.activeWhite : COLORS.white}
                                />
                                {isActive && <View style={styles.activeDot} />}
                            </View>
                            <Text style={[
                                styles.navText,
                                { color: isActive ? COLORS.activeWhite : COLORS.inactiveText, fontWeight: isActive ? '700' : '400' }
                            ]}>
